...
import Samu from '@/assets/img/emergencia/samu.png'
import Bombeiros from '@/assets/img/emergencia/bombeiros.png'
import DefCivil from '@/assets/img/emergencia/defesa-civil.png'
import PolCivil from '@/assets/img/emergencia/policia-civil.png'
import PolMilitar from '@/assets/img/emergencia/policia-militar.png'
import PolRodoviaria from '@/assets/img/emergencia/policia-rodoviaria.png'

export default function CardEmergencia(props) {
    ...
    const cardBackground = {
        ...
        minHeight:"220px",
        maxHeight:"220px",
        backgroundImage: "linear-gradient(135deg, rgb(28,28,28,0.8) 50%, rgb(28,28,28,0.6) 50%)",
        borderRadius: "10px",
        float: "left",
        display: "flex",
        flexWrap: "wrap",
